...
describe('ImageDetailsComponent', () => {
 ...
 spy = spyOn(mockService,'getImage').and.returnValue({ "id": 2, "brand": "perro", "url": "assets/images/perro2.jpg"});
  ...
  it('cuando la imagen existe es 2  debe retornar el json  del imageService indicado',()=>{
    expect(component.image).toEqual({ "id": 2, "brand": "perro", "url": "assets/images/perro2.jpg"})
